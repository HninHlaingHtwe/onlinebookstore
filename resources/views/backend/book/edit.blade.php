<x-backend>
    ...
    <main class="app-content">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="tile">
                    <div class="tile-body">
                        <form action="{{ route('backside.book.update',$id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="name_id" name="name" value="{{ $bookname }}">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <label for="photo_id" class="col-sm-2 col-form-label"> Pdf</label>
                                <div class="col-sm-10">
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link active" id="home-tab" data-toggle="tab" href="#oldpdf" role="tab" aria-controls="home" aria-selected="true">Old Pdf</a>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link" id="profile-tab" data-toggle="tab" href="#newpdf" role="tab" aria-controls="profile" aria-selected="false">New Pdf</a>
                                        </li>

                                    </ul>
                                    <div class="tab-content" id="myTabContent">
                                        <div class="tab-pane fade show active" id="oldpdf" role="tabpanel" aria-labelledby="home-tab">
                                            <img src="{{asset($pdf)}}" id="editphoto" width="100" height="100"></div>
                                            <div class="tab-pane fade" id="newpdf" role="tabpanel" aria-labelledby="profile-tab"><input type="file" name="pdf"></div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="name_id" name="publisher" value="{{ $publisher }}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="name_id" class="col-sm-2 col-form-label"> Edition </label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="name_id" name="edition" value="{{ $edition }}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="name_id" class="col-sm-2 col-form-label"> Status </label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="name_id" name="edition" value="{{ $status }}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="i_review" class="col-sm-2 col-form-label"> Review </label>
                                <div class="col-sm-10">
                                    <textarea class="form-control" id="i_review" name="review"> {{ $review }} </textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="publishdate" class="col-sm-2 col-form-label"> Publish Date </label>
                                <div class="col-sm-10">
                                    <input type="date" class="form-control" id="publishdate" name="publishdate" value="{{$publishdate}}">
                                </div>
                            </div>

                            <div class="form-group row">
                                <label for="photo_id" class="col-sm-2 col-form-label"> Author </label>
                                <div class="col-sm-10">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var images = JSON.parse('{!! $book->photo !!}');
