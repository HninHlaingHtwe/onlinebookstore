        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="breadcrumb__text" style="height: 20vh;padding-top: 30px;">
                        <h2> Register </h2>
                    </div>
                </div>
            </div>
                ...
                <div class="col-8">
                    <form action="{{route('register')}}" method="POST">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="col-12">
                                    {{-- <select class="form-control" name="township">
                                        <option>Choose Township
                                        </option>
                                        
                                        <option value=""></option>
                                        
                                    </select> --}}
                                    <input type="text" name="township" class="form-control py-4">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="text-center">
                           ...
                           {{--  <a href="" class="btn register-btn" type="submit">Create Account</a> --}}
                        </div>
                    </form>
