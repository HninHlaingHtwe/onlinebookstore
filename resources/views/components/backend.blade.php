...
<html lang="en">
    <head>
        ...
        <!-- Favicon-->
        <link rel="icon" href="{{asset('frontend/img/favicon.png')}}" type="image/gif" sizes="16x16">

        <!-- iconfont CSS -->
        <link rel="stylesheet" type="text/css" href="{{ asset('frontend/fonts/icofont.min.css')}}">
    ...
    <body class="app sidebar-mini">
        ...
        <header class="app-header">
            <a class="app-header__logo" href="index.html">
                <img src="{{ asset('frontend/img/favicon.png')}}" style="width: 50px; height: 50px">
                WorldBook
            </a>
            ...
            <ul class="app-nav">
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu settings-menu dropdown-menu-right">
                    ...
                    <li>
                        <a href="javascript:void(0)" class="dropdown-item" onclick="event.preventDefault();document.getElementById('logout-form').submit();"><i class="icofont-logout"></i>Log Out </a>
                    </li>
        ...
        <aside class="app-sidebar">
            ...
            <ul class="app-menu">
                ...
                <li>
                    <a class="app-menu__item {{ Request::segment(2)==='instock'? 'active':''}}" href="{{route('backside.instock.index')}}">
                ...
                <li>
                    <a class="app-menu__item {{ Request::segment(2)==='author'? 'active':''}}" href="{{ route('backside.author.index')}}" >
                ...
                <li>
                    <a class="app-menu__item {{ Request::segment(2)==='book'? 'active':''}}" href="{{ route('backside.book.index')}}" >
                        <i class="app-menu__icon icofont-package"></i>
                        <span class="app-menu__label">
                            Books
                        </span>
